...
db = DataBase()
mailing_time = "10:00"
help_message = f'Привет! Я финансовый бот.\nЧто я могу:\n' \
               f'/news: Присылаю 10 актуальных новостей с сайта rbc.ru.\n' \
               f'/conversion: Конвертирую любые валюты.\n' \
               f'/mailing: Возможность подписаться или ' \
               f'отписаться от рассылки новостей и курсов валют.' \
               f'Сообщения с рассылкой приходят в 13:00 по московскому ' \
               f'времени.'
